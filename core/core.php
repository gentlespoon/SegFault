...
if (file_exists(ROOT."config/config.php")) require_once(ROOT."config/config.php"); else die("FATAL ERROR: Configuration file <span style='font-family: monospace'>config/config.php</span> does not exist.");
